...
var dbMethods = require('../models/deductions');
			...
			init: function (main_callback){
				var taskNamed = {
					//base
						...
						deductionsTypes: function (callback) {
							methods.getDeductionsTypes(function(result){
							callback(null, result);
							});
						},
						deductions: function (callback) {
							methods.getDeductions(function(result){
							callback(null, result);
							});
						},
						//base
